...
const cards = [
  {
    ...
    image: "/kankana-silks-webp/DSC07869.webp",
  },
  {
    title: "Affordable",
    subtitle: "Everyday Elegance",
    image: "/kankana-silks-webp/DSC07286.webp",
  },
  {
    title: "Wedding",
    subtitle: "Bridal Heritage",
    image: "/kankana-silks-webp/DSC06693.webp",
  },
  {
    title: "Contemporary",
    subtitle: "Modern Drapes",
    image: "/kankana-silks-webp/DSC06240.webp",
  },
  {
    title: "Luxury",
...
export default function PremiumCollectionCarousel() {
  ...
  return (
    <section className="relative w-full bg-white py-16 sm:py-24 overflow-hidden">
      {/* HEADER */}
      <div className="px-6 sm:px-16 mb-12">
