import { ChevronRight, CreditCard, HelpCircle, LogOut, MapPin, Settings, ShoppingBag, User, Video } from 'lucide-react';
...
export default function ProfileDesktop({ pageVariants, profileData }: IProps) {
  return (
    <motion.div
